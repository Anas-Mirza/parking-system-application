package com.mirzabeg.myparkingapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mirzabeg.myparkingapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mirzabeg.myparkingapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
