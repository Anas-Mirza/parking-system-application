...
export class BookingDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('parkingSystemApplicationApp.booking.delete.question'));
...
export default class BookingComponentsPage {
  ...
  async deleteBooking() {
    ...
    expect(await bookingDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/parkingSystemApplicationApp.booking.delete.question/);
