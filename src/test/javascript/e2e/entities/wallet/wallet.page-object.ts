...
export class WalletDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('parkingSystemApplicationApp.wallet.delete.question'));
...
export default class WalletComponentsPage {
  ...
  async deleteWallet() {
    ...
    expect(await walletDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/parkingSystemApplicationApp.wallet.delete.question/);
